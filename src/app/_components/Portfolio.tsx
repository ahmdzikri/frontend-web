      ...
      <div className="container">
        <div className="grid grid-cols-1 gap-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-heading text-center uppercase text-transparent bg-clip-text bg-gradient-to-r from-white/40 via-white/100 to-white/40 !leading-[0.9] text-[18vw] xs:text-[16vw] md:text-[14vw] lg:text-[8vw] xl:text-[8vw] 2xl:text-[8vw]">
              Portfolio Review
            </h2>{" "}
            <p className="mt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-4 gap-y-4 w-full">
            <div className="w-full rounded-2xl bg-gray-900 flex flex-col items-center text-center px-4 sm:px-8 py-5 sm:py-8">
              ...
              >
                <div className="aspect-square w-16 flex-shrink-0 overflow-hidden border-[3px] border-gray-900 rounded-full">
                  <img
                    src="https://indonesiacomiccon.com/_nuxt/img/mkc-studio.a702225.webp"
            ...
            <div className="w-full rounded-2xl bg-gray-900 flex flex-col items-center text-center px-4 sm:px-8 py-5 sm:py-8">
              ...
              >
                <div className="aspect-square w-16 flex-shrink-0 overflow-hidden border-[3px] border-gray-900 rounded-full">
                  <img
                    src="https://indonesiacomiccon.com/_nuxt/img/tawakal.ac1ffb8.webp"
            ...
            <div className="w-full rounded-2xl bg-gray-900 flex flex-col items-center text-center px-4 sm:px-8 py-5 sm:py-8">
              ...
              >
                <div className="aspect-square w-16 flex-shrink-0 overflow-hidden border-[3px] border-gray-900 rounded-full">
                  <img
                    src="https://indonesiacomiccon.com/_nuxt/img/brandoville.8fae3d1.webp"
            ...
            <div className="w-full rounded-2xl bg-gray-900 flex flex-col items-center text-center px-4 sm:px-8 py-5 sm:py-8">
              ...
              >
                <div className="aspect-square w-16 flex-shrink-0 overflow-hidden border-[3px] border-gray-900 rounded-full">
                  <img
                    src="https://indonesiacomiccon.com/_nuxt/img/m&amp;c.d20742e.webp"
