    ...
    <div id="meet-and-greet" className="pt-16 lg:pt-24">
      <div className="container">
        <div className="flex flex-col items-center text-center">
          <h2 className="font-heading uppercase text-transparent bg-clip-text bg-gradient-to-r from-white/40 via-white/100 to-white/40 !leading-[0.9] text-[18vw] xs:text-[16vw] md:text-[14vw] lg:text-[8vw] xl:text-[8vw] 2xl:text-[8vw]">
            Meet and Greet
          </h2>{" "}
          <p className="mt-5">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-x-4 gap-y-8 mt-10">
          <div className="relative isolate">
            <div className="relative z-10">
              <img
                src="https://indonesiacomiccon.com/_nuxt/img/moona-hoshinova.3a87891.webp"
                alt="Moona Hoshinova"
                loading="lazy"
          ...
          <div className="relative isolate">
            <div className="relative z-10">
              <img
                src="https://indonesiacomiccon.com/_nuxt/img/pavolia-reine.56991c1.webp"
                alt="Pavolia Reine"
                loading="lazy"
                className="aspect-[4/5] w-full"
              />{" "}
          ...
          <div className="relative isolate">
            <div className="relative z-10">
              <img
                src="https://indonesiacomiccon.com/_nuxt/img/ayunda-risu.ab5cb8e.webp"
                alt="Ayunda Risu"
                loading="lazy"
                className="aspect-[4/5] w-full"
              />{" "}
          ...
          <div className="relative isolate">
            <div className="relative z-10">
              <img
                src="https://indonesiacomiccon.com/_nuxt/img/kobo-kanaeru.6df856d.webp"
                alt="Kobo Kanaeru"
                loading="lazy"
                className="aspect-[4/5] w-full"
              />{" "}
